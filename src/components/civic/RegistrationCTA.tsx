  ...
  return (
    <section id="register" className="relative w-full py-16 md:py-24">
      <div className="mx-auto max-w-4xl px-4 md:px-8">
        ...
        {/* CTA Card */}
        <div
          className="relative border-2 border-[#1e1e1e] rounded-[28px] p-6 md:p-12 lg:p-16 text-center"
        ...
        >
          ...
          <div className="relative z-10">
            <p
              className="text-base md:text-xl mb-6 md:mb-8 px-2"
            ...
            <button
              ...
              className="group relative overflow-hidden inline-block w-full sm:w-auto px-8 sm:px-12 py-4 sm:py-5 rounded-full bg-[#E6B800] border-2 border-[#1e1e1e] text-[#1e1e1e] font-medium text-base sm:text-xl transition-all duration-300 hover:scale-105 hover:shadow-xl"
            >
              <div
            ...
            <p
              className="text-xs sm:text-sm mt-4 md:mt-6 text-gray-600"
